<div class="space-y-4 p-4 bg-white dark:bg-gray-800 rounded-lg shadow-md">
    ...
    <p class="text-gray-700 dark:text-gray-300">This is the content for the DS Division Wise Registration.</p>
    ...
    <p class="mt-2 text-gray-700 dark:text-gray-300">
        ...
        <form id="dsDivisionWiseRegistrationForm" class="space-y-6">
            ...
            <div class="inline-block">
                <label for="dsDivision" class="block text-sm font-medium text-gray-700 dark:text-gray-300">DS Division:</label>
                <select id="dsDivision" name="dsDivision" class="mt-1 block py-2 px-3 border border-gray-300 bg-white dark:bg-gray-700 dark:text-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" required>
