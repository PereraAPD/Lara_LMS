            ...
            <form method="POST" action="{{ route('branch.store') }}">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <x-input id="branch_code" class="block mt-1 w-full" type="text" name="branch_code" :value="old('branch_code')" required autofocus />
                    ...
                    <div>
                        ...
                        <x-input id="branch_name" class="block mt-1 w-full" type="text" name="branch_name" :value="old('branch_name')" required />
